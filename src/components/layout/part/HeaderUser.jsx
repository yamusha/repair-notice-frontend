  ...
  render() {
    ...
    return (
      <Dropdown.Uncontrolled {...attributes}>
        ...
        <Dropdown.Menu wide right animated className="py-0 overflow-hidden">
          {/* BEGIN Portlet */}
          <Portlet scroll className="border-0">
            {/* <Portlet.Header className="bg-primary rounded-0">
              <RichList.Item className="p-0 w-100">
            ...
            <Portlet.Footer bordered className="rounded-0 text-right">
